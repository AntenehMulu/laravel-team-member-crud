    ...
    <div class="p-10 max-w-screen-lg mx-auto">
        <div class="text-center mb-4">
            ...
            <h3 class="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900">
                Laravel<span class="text-indigo-600"> Team 3</span> Member
            </h3>
...
@foreach ($teamlist as $member)
            ...
            C93.282,101.457,89.661,116.261,93.282,126.483z"></path>
                        ...
                        <div class="my-4 flex">
                            ...
                            <a href="{{ route('member.edit',['teamMember'=>$member]) }}"><button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Edit</button></a>
                            <a href="">
                                <form method="post" action="{{ route('member.destroy',['teamMember'=>$member])}}">
                                    @csrf
                                    @method('delete')
                                <input type="submit" class="text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900" value="Delete">
                                </form>
                            </a>
